      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Navigation horizontale (Accueil, Vidéos, Films, Séries, Musique, Playlists, En direct)
            SizedBox(
              height: 40,
              child: ListView(
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        if (seeAll)
          const Text('Voir tout >', style: TextStyle(fontSize: 12, color: Colors.blue)),
      ],
    );
  }
}
        ...
        return Padding(
          ...
          child: Row(
            children: [
              Container(
                width: 32,
                child: Text(item['rank'], style: const TextStyle(fontWeight: FontWeight.bold, fontSize: 14, color: Colors.grey)),
              ),
              Expanded(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
