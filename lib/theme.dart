...
class AdminCyberGradients {
  static LinearGradient glowBlue() =>
...
class EmergencyUrgentColors {
  ...
  static const danger =
      DarkModeColors.emergencyRed;

  static const medicalBlue =
      Color(0xFF2F7DFF);

  static const safetyGreen =
      Color(0xFF22C55E);

  static const fireOrange =
      Color(0xFFFF6A3D);
...
class LearningCyberColors {
  ...
  static const panel =
      AdminCyberColors.panel;

  static const panelHi =
      AdminCyberColors.panelHi;
...
class LearningCyberGradients {
  static LinearGradient glowBlue() =>
      AdminCyberGradients.glowBlue();

  static LinearGradient glowViolet() =>
      AdminCyberGradients.glowViolet();

  static LinearGradient background() =>
      EmergencyUrgentGradients.background();
}
